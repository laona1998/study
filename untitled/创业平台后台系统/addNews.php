...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="...">
            <h2 style="margin-left: 40px">添加新闻</h2>
            <form class="layui-form" method="post" style="margin-left: 40px;width:80%" action="admin/sever_addNews.php" enctype="multipart/form-data">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="test" name="user_id" required lay-verify="required" placeholder="请输入发布人ID" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">标题</label>
                    <div class="layui-input-block">
                        <input type="test" name="title" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    editor.config.uploadImgServer = 'admin/upload_wang.php'
