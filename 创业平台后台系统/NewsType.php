...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scrol">
            ...
            <ul class="layui-nav layui-nav-tree " lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="javascript:;">查看分类</a></dd>
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <div style="...">
            <h2 style="margin-left: 40px">新闻</h2>
            <form class="layui-form" method="post" style="margin-left: 40px;width:80%" >
                <div class="layui-form-item">
                    <label class="layui-form-label">查看分类</label>
